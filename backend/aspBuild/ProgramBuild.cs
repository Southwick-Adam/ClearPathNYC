...
class Program
{
    public static async Task Main(string[] args)
    {
        ...
        string jsonPathTaxi = "csFiles\\DataFiles\\NYC Taxi Zones.geojson";
        string jsonTaxi = File.ReadAllText(jsonPathTaxi);
        string csvPathMetro = "csFiles\\DataFiles\\Subway_Data_Final.csv";
        string csvPedTypePath = "csFiles\\DataFiles\\Pedestrian.csv";
        string csvParksPath = "csFiles\\DataFiles\\Manhattan_Parks_cleaned.csv";
