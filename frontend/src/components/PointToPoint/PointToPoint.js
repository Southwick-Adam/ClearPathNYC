...
//         console.log(`Moving waypoint up: currentInput=${currentInput}, previousInput=${previousInput}`);
//         waypointStates[index].geocoderRef.current.query(previousInput);
//         waypointStates[index - 1].geocoderRef.current.query(currentInput);
//       }
//     }
//   }
...
//         console.log(`Moving waypoint down: currentInput=${currentInput}, nextInput=${nextInput}`);
//         waypointStates[index].geocoderRef.current.query(nextInput);
//         waypointStates[index + 1].geocoderRef.current.query(currentInput);
//       }
//     }
//   }
...
//         ))}
//         {visibleWaypoints < 5 && (
//           <button type='button' onClick={handleAddWaypoint}>+</button>
//         )}
//       </div>
//     </form>
//   );
